    ...
    **kwargs
    ...
    if is_mm_model(model_path):
        ...
        if "lora" in model_name.lower() and model_base is not None:
            ...
            model = LlavaLlamaForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True, device_map=device, **kwargs)
    else:
        # Load language model
    ...
    if is_mm_model(model_path):
        ...
        if not vision_tower.is_loaded:
            vision_tower.load_model(device_map=device, vision_tower_path=vision_tower_path)
        if device != "auto":
